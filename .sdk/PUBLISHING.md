...
|---|---|---|
| `js/` | @voxgig-sdk/commonroom-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/commonroom | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/commonroom-js \
      --repository voxgig-sdk/commonroom-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/commonroom-js` shows it, and
`npm trust revoke @voxgig-sdk/commonroom-js --id=<id>` removes it.
