...
// Commonroom SDK utility: fetcher

class CommonroomFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CommonroomSDK/1.0)';
    ...
    public static function call(CommonroomContext $ctx, string $fullurl, array $fetchdef): array
    {
