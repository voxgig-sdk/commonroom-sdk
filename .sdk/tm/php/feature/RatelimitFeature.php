...
// Commonroom SDK ratelimit feature
...
class CommonroomRatelimitFeature extends CommonroomBaseFeature
{
    ...
    private function _acquire(CommonroomContext $ctx): void
    {
    ...
    private function _track(CommonroomContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
