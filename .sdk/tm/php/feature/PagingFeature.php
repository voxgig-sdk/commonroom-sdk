...
class CommonroomPagingFeature extends CommonroomBaseFeature
{
    ...
    private function _graphql_pre_request(CommonroomContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(CommonroomContext $ctx): bool
    {
