...
// Commonroom SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CommonroomTestFeature extends CommonroomBaseFeature
{
    ...
    public function init(CommonroomContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CommonroomContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CommonroomParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CommonroomContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CommonroomContext $ctx, $op, $args): array
    {
