...
// Commonroom SDK timeout feature
...
class CommonroomTimeoutFeature extends CommonroomBaseFeature
{
    ...
    private function _with_timeout(CommonroomContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CommonroomContext $_ctx, float $ms): void
    {
        $client = $this->client;
