...
from projectname_sdk import CommonroomSDK
from projectname_sdk.core.spec import CommonroomSpec
from projectname_sdk.core.result import CommonroomResult
from projectname_sdk.core.response import CommonroomResponse
from projectname_sdk.core.operation import CommonroomOperation
from projectname_sdk.core.error import CommonroomError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CommonroomBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CommonroomError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = CommonroomSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = CommonroomSDK.test(None, None)
        ...
        class TestInitFeature(CommonroomBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CommonroomBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CommonroomSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CommonroomSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CommonroomSDK.test(None, setup_opts)
