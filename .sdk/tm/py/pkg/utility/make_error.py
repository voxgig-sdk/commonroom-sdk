# Commonroom SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, CommonroomError):
        errmsg = err.msg
    ...
    msg = "CommonroomSDK: " + opname + ": " + errmsg
    ...
    sdk_err = CommonroomError("", msg, ctx)
