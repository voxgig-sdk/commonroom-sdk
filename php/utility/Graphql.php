...
// Commonroom SDK utility: graphql
//
...
class CommonroomGraphql
{
    ...
    // equivalent.
    public static function body(CommonroomContext $ctx): mixed
    {
    ...
    public static function errors(CommonroomContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
