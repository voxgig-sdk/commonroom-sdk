...
class CommonroomTestRunner
{
    ...
    {
        $live = self::getenv('COMMONROOM_TEST_LIVE');
        $override = self::getenv('COMMONROOM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('COMMONROOM_TEST_EXPLAIN');
...
class_alias('CommonroomTestRunner', 'Runner');
class_alias('CommonroomHelpers', 'Helpers');
