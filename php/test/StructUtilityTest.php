...
// Commonroom SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CommonroomOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CommonroomOmni::structfix($now, Struct::undef()))
                        !== json_encode(CommonroomOmni::structfix($val, Struct::undef()))) {
