...
{
    private static function utility(): CommonroomUtility
    {
        return new CommonroomUtility();
    }
    ...
    private static function ctx(array $over = []): CommonroomContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CommonroomContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CommonroomOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CommonroomError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CommonroomOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CommonroomMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CommonroomOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CommonroomMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CommonroomOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CommonroomMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CommonroomSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CommonroomMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CommonroomResponse([]),
            'result' => new CommonroomResult([]),
        ]);
        [, $err] = CommonroomMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CommonroomSpec([]),
            'response' => null,
            'result' => new CommonroomResult([]),
        ]);
        [, $err] = CommonroomMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CommonroomSpec(['step' => 's']),
            'response' => new CommonroomResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CommonroomResult([]),
        ]);
        [, $err] = CommonroomMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CommonroomSpec(['step' => 's']),
            'response' => new CommonroomResponse(self::resp(200, ['v' => 1])),
            'result' => new CommonroomResult([]),
        ]);
        [, $err] = CommonroomMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CommonroomSpec(['step' => 's']),
            'response' => new CommonroomResponse(self::resp(200, ['v' => 2])),
            'result' => new CommonroomResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CommonroomMakeResponse::call($ctx);
    ...
    {
        $preset = new CommonroomResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CommonroomSpec([]),
            'response' => new CommonroomResponse([]),
            'result' => new CommonroomResult([]),
        ...
        [$got, $err] = CommonroomMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CommonroomResult([])]);
        [, $err] = CommonroomMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CommonroomSpec([]), 'result' => null]);
        [, $err] = CommonroomMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CommonroomSpec(['step' => 's']),
            'result' => new CommonroomResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CommonroomOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CommonroomMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CommonroomSpec(['step' => 's']),
            'result' => new CommonroomResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CommonroomOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CommonroomMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CommonroomResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CommonroomSpec([]),
            'result' => new CommonroomResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CommonroomMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CommonroomMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CommonroomError('boom', 'boom');
        $utility->fetcher = function (CommonroomContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CommonroomSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CommonroomMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CommonroomContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CommonroomMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CommonroomResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CommonroomMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CommonroomContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CommonroomSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CommonroomMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CommonroomResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CommonroomSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CommonroomMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CommonroomMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CommonroomMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CommonroomResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CommonroomDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CommonroomResult(['ok' => false])]);
        $this->expectException(CommonroomError::class);
        CommonroomDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CommonroomResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CommonroomMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CommonroomMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CommonroomBaseFeature();
        $b = new CommonroomBaseFeature();
        CommonroomFeatureAdd::call($ctx, $a);
        CommonroomFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CommonroomBaseFeature
    {
        $f = new CommonroomBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CommonroomFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CommonroomContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CommonroomSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CommonroomPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CommonroomPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CommonroomResponse(['headers' => null]),
            'result' => new CommonroomResult([]),
        ]);
        CommonroomResultHeaders::call($ctx);
