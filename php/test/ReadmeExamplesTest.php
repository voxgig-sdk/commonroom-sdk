...
// Commonroom SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CommonroomSDK::test)
...
{
    private const SDK_CLASS = 'CommonroomSDK';
    ...
    private const SDK_BASE = 'commonroom_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../commonroom_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
