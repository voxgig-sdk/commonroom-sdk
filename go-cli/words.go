...
func registerSDKWords(r *eng.Registry, client *sdk.CommonroomSDK) {
...
func runOp(client *sdk.CommonroomSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
