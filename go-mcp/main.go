// Command Commonroom-mcp is an MCP server exposing the Commonroom
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Commonroom_list  — list records of an entity
//	Commonroom_load  — load a single record of an entity
//
