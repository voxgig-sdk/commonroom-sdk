...
func registerTools(server *mcp.Server, client *sdk.CommonroomSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "commonroom_list",
		Description: "List records from Commonroom. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "commonroom_load",
		Description: "Load a single record from Commonroom. " +
...
func runOp(client *sdk.CommonroomSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CommonroomSDK, name string) (sdk.CommonroomEntity, error) {
