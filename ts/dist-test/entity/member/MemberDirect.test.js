...
(0, node_test_1.describe)('MemberDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('COMMONROOM_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CommonroomSDK({
    ...
    (0, node_test_1.test)('direct-load-member', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-member', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["community01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.community_id = setup.idmap['community01'];
        }
        else {
            params.community_id = 'direct01';
            params.id = 'direct02';
        }
        const result = await client.direct({
            path: '{community_id}/members/{id}',
            method: 'GET',
            params,
            query,
        });
...
function liveScenariosActive() { return false && process.env.COMMONROOM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CommonroomSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
    ...
    const client = new __1.CommonroomSDK({
        base: 'http://localhost:8080',
