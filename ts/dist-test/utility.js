...
function envOverride(m) {
    if ('TRUE' === process.env.COMMONROOM_TEST_LIVE ||
        'TRUE' === process.env.COMMONROOM_TEST_OVERRIDE) {
    ...
    m.COMMONROOM_TEST_EXPLAIN = process.env.COMMONROOM_TEST_EXPLAIN || m.COMMONROOM_TEST_EXPLAIN;
    return m;
}
