...
from commonroom_sdk.utility import register

# Load features
from commonroom_sdk.feature.base_feature import CommonroomBaseFeature
from commonroom_sdk.features import _has_feature, _make_feature
...
class CommonroomSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CommonroomUtility()
        self._utility = utility

        from commonroom_sdk.config import shared_config
    ...
    def get_utility(self):
        return CommonroomUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CommonroomSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Member(self, data=None) -> "MemberEntity":
        ...
        from commonroom_sdk.entity.member_entity import MemberEntity
        return MemberEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CommonroomSDK":
        if sdkopts is None:
            sdkopts = {}
