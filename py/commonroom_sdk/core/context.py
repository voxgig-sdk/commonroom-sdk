...
from commonroom_sdk.core.control import CommonroomControl
...
from commonroom_sdk.core.helpers import get_ctx_prop, to_map
...
class CommonroomContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, CommonroomSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CommonroomResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CommonroomResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CommonroomError(code, msg, self)
