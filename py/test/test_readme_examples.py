# Commonroom SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CommonroomSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CommonroomSDK(...) and CommonroomSDK.test(...) become
#      CommonroomSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "commonroom_sdk"
_SDK_CLASS = "CommonroomSDK"
